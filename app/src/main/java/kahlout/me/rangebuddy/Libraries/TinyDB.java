...
/**
 * Created by malikahlout on 26/02/2017.
 */
...
public class TinyDB {
    ...
    /**
     *
     * Get List of clubs from shared preferences if available.
     *
     *
     */
...
//     */
    ...
    public int getIntUnits(String key) {

        return preferences.getInt(key, 0);
    }

    ///
    /// Get custom Int for Flag Size
    ///
